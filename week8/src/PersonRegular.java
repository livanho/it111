public class PersonRegular {
    public static void main(String[] args) {
        ...
        //logic in the car insurance industry - if you have traffic tickets, DUIs, other violations, you will be paying more for insurance also, if you have a poor credit, you will pay more money
        ...
        //will gender and age make difference?
        ...
        System.out.println("First Person Preliminary Monthly Rate: " + monthlyRate1 + "$");
        System.out.println("First Person Monthly Rate (including gender and age): " + total1 + "$");
        ...
        System.out.println("Second Person Preliminary Monthly Rate: " + monthlyRate2 + "$");
        System.out.println("Second Person Monthly Rate (including gender and age): " + total2 + "$");
